...
class BaseAviary_(gym.Env):
    ...
    def _parseURDFParameters(self):
        ...
        """
        # correct path to urdf file: /home/sergi/github_repos/Thesis/swarm/3D_implementation/assets
        path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'assets/'+self.URDF)
